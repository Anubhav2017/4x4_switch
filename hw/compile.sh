...
# aa2c model.
TOPMODULES="-T inputPort_1_Daemon -T inputPort_2_Daemon -T outputPort_1_Daemon -T outputPort_2_Daemon -T inputPort_3_Daemon -T inputPort_4_Daemon -T outputPort_3_Daemon -T outputPort_4_Daemon"
rm -rf aa2c
mkdir aa2c
